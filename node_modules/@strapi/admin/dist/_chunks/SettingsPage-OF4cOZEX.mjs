...
import { y as SETTINGS_LINKS_CE, p as useEnterprise, u as useConfiguration, d as createRoute } from "./index-KLPMzfLn.mjs";
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-QcAGYy1f.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-oQRoZt1p.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-fzTcqNI4.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage--J1dsByF.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-fEoCz13v.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-RIOdcpEj.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-9ewfnebV.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-dvT_6puE.mjs").then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-aEm1evEt.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-BiPc2Nc1.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-QVnYlajx.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-7PPdoPu1.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-5rpxCdVv.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-2uBQgcn1.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-C5CfkXdo.mjs");
      return ProtectedEditView;
    },
  ...
  {
    async Component() {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-zQio54Q3.mjs");
  ...
  {
    async Component() {
      const { PurchaseReviewWorkflows } = await import("./PurchaseReviewWorkflows-zGnRRqrC.mjs");
  ...
  {
    async Component() {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-BQ5PU-6E.mjs");
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-i1rd-M1M.mjs")).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-sJFx6aQR.mjs")).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-OF4cOZEX.mjs.map
