...
const useWebhooks = require("./useWebhooks-H34bjR-D.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-ya4-snYx.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-DbHeF44w.js.map
