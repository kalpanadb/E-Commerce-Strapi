...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-KLPMzfLn.mjs";
...
import { u as useWebhooks } from "./useWebhooks-0S-LOa28.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-aTOj5Iwg.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-dvT_6puE.mjs.map
