...
const admin = {
  ...
  register(app) {
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        async Component() {
          const { App } = await Promise.resolve().then(() => require("./App-x6I6piPB.js"));
          return App;
        },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en--WvbU-_H.js")) }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-M4gICzzI.js.map
