...
const admin = {
  ...
  register(app) {
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        async Component() {
          const { App } = await import("./App-M11U5GPh.mjs");
          return App;
        },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-oREbrNEq.mjs") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=index-Ls9Qc5Tg.mjs.map
