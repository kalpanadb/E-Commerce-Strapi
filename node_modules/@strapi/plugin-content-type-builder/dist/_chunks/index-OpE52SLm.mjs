...
const ListView$1 = lazy(() => import("./ListView-v9Hz5j5D.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-v9Hz5j5D.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-OpE52SLm.mjs.map
