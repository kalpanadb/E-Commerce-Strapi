...
const index$1 = require("./index-o3qDfjbc.js");
  ...
  const shape = {
    displayName: yup__namespace.string().test({
      ...
      test(value) {
        ...
        return !usedComponentNames.includes(name) && !takenCollectionNames.includes(currentCollectionName);
      }
    }).test({
      name: "nameNotAllowed",
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-aoXKuvLK.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-aoXKuvLK.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-M3f8Wmbn.js.map
